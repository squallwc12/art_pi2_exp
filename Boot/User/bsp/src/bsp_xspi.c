...
/**
 * @brief  Reset the external flash memory
 * @param  None
 * @retval BSP status
 */
static bsp_int32_t bsp_extmem_flash_reset(void)
{
    /* Reset in OPI DTR mode (in case flash was previously configured to OPI) */
    W35T51NWTBIE_ResetEnable(&hxspi2, W35T51NWTBIE_OPI_MODE, W35T51NWTBIE_DTR_TRANSFER);
    W35T51NWTBIE_ResetMemory(&hxspi2, W35T51NWTBIE_OPI_MODE, W35T51NWTBIE_DTR_TRANSFER);

    /* Reset in SPI STR mode (in case flash is still in default SPI mode) */
    W35T51NWTBIE_ResetEnable(&hxspi2, W35T51NWTBIE_SPI_MODE, W35T51NWTBIE_STR_TRANSFER);
    W35T51NWTBIE_ResetMemory(&hxspi2, W35T51NWTBIE_SPI_MODE, W35T51NWTBIE_STR_TRANSFER);
